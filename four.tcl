#Q4 Stimulate the transmission of ping messages over a network topology consisting of 6 nodes and find the number of dropped packets due to congession
...
#craete linkes betweeen the nodes 
for {set i 1} {$i<4} {incr i} {
	$ns duplex-link $n($i) $n(0) 1Mb 10ms Droptail
	
}
$ns duples-link $n(4) $n(0) 1Mb 100ms Droptail
$ns duples-link $n(5) $n(0) 1Mb 100ms Droptail
$ns duples-link $n(6) $n(0) 1Mb 90ms Droptail

Agent/Ping instproc recv {from rtt} {
	$self instvar node_
	puts "node [$node_ id] revieved ping answers from \
