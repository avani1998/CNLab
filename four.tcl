#Q4 Stimulate the transmission of ping messages over a network topology consisting of 6 nodes and 
#find the number of dropped packets due to congession
...
#create linkes betweeen the nodes 
